...
|---|---|---|
| The agent beats the best hand-written rulebook, which reads **the same outage forecast it does** | **53 % fewer dry hours** (0.156 vs 0.33 per day, 365 days, identical seeds) | `README.md` -> *What each policy costs the city* |
